...
{   isLoading? <Loader/> : isError ? <span className='text text_type_main-medium '>Произошла ошибка, обновите страницу.</span> : <div className={styles.ingredientsWrapper}>
          ...
          <section className='ingredientSection sauces' id='sauce' ref={sausesRef}>
